...
CREATE TABLE ANIMAL_STORAGE (
	...
	LABOR INT NOT NULL, -- SỐ NHÂN CÔNG 
	ACREAGE FLOAT NOT NULL, -- DIỆN TÍCH 
	IMAGE_ANIMAL_STORAGE NVARCHAR(MAX), -- bản đồ cơ sở lưu trữ động vật (LInk ẢNh)
    ID_COMMUNE INT NOT NULL,
    FOREIGN KEY (ID_COMMUNE) REFERENCES COMMUNE(ID)
);
GO
...
CREATE TABLE ANIMAL_CATEGORY (
    ...
    STATUS INT, -- TRẠNG THÁI BẢO TỒN (1 - NGUY CẤP ,0 - ỔN ĐỊNH, 2 - Tuyệt chủng)
...
--(N'Hổ', N'Panthera tigris', 20.960, 105.350, '2024-01-15', 5, 1, N'Loài hổ được tìm thấy trong rừng.', 1),
--(N'Sao', N'Ailuronycteris', 20.960, 105.350, '2024-01-20', 10, 0', N'Loài sao được tìm thấy trong các khu vực rừng.', 1),
--(N'Hưu', N'Cervus elaphus', 20.960, 105.350, '2024-01-25', 8, 0, N'Loài hươu với bộ lông đẹp.', 1),
---- Dữ liệu cho Tèn Tén
